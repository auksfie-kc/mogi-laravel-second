...
<div class="attendance-list">
    ...
    <div class="attendance-month__heading">
        ...
        <div class="text-center">
            ...
            <a href="{{ route('attendance.list') }}">{{ $thisMonth->format('Y/m') }}</a>
    ...
    <div class="attendance__table">
        <table>
            ...
            <tr>
                <!--指定月の日付を全表示-->
                <td>{{ \Carbon\Carbon::parse($attendance['date'])->isoformat('MM月DD日（ddd）') }}</td>

                <!--指定月の日付を全表示の中に勤怠のデータがあれば取得して表示-->
                ...
                <td>@if ($attendance['attendance'])
                    <a href="{{ route('attendance.show',['id' => $attendance['attendance']->id])}}">詳細</a>
                    @else
                    -
                    @endif
                </td>
